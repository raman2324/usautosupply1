      ...
      <section className="border-b border-line-200">
        <div className="container-x py-16 md:py-20">
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {VERTICALS.map((v, i) => (
              <a key={v.name} href="#" className={`group flex flex-col overflow-hidden rounded-md border border-line-200 bg-white transition hover:border-us-navy-700 ${i === 0 ? "lg:col-span-2 lg:row-span-2" : ""}`}>
                <div className={`relative ${i === 0 ? "aspect-[16/10]" : "aspect-[4/3]"} overflow-hidden bg-paper-100`}>
